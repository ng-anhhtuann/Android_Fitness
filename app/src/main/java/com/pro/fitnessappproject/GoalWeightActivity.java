...
public class GoalWeightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kg = findViewById(R.id.kg_btn);
        lb = findViewById(R.id.lb_btn);
        edittext = findViewById(R.id.edittextgoal);
        textview = findViewById(R.id.textview);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(GoalWeightActivity.this, AgeActivity.class);
                finish();
            }
        });
                ...
                next.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (Integer.parseInt(edittext.getText().toString()) >= 20 && Integer.parseInt(edittext.getText().toString()) <= 200) {
                            Intent b = new Intent(GoalWeightActivity.this, LevelActivity.class);
                            startActivity(b);
                        } else {
                            Toast.makeText(GoalWeightActivity.this, "Please try again between 20 vs 200", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
                ...
                next.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (Integer.parseInt(edittext.getText().toString()) >= 40 && Integer.parseInt(edittext.getText().toString()) <= 400) {
                            ...
                            Toast.makeText(GoalWeightActivity.this, "Please try again between 40 vs 400", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
